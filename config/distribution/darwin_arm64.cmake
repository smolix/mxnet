...
set(CFLAGS "-fPIC" CACHE STRING "CFLAGS")
set(CXXFLAGS "-fPIC" CACHE STRING "CXXFLAGS")
set(CMAKE_C_FLAGS "-fPIC" CACHE STRING "C compiler flags")
set(CMAKE_CXX_FLAGS "-fPIC" CACHE STRING "C++ compiler flags")
...
set(USE_NCCL OFF CACHE BOOL "Use NVidia NCCL with CUDA")
set(USE_NVML OFF CACHE BOOL "Build with nvml support if found")
...
set(USE_INTGEMM OFF CACHE BOOL "Build with x86_64 intgemm library for low-precision multiplication")
