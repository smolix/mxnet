...
| ID | Status | Area | Issue |
|---|---|---|---|
| T1 | Open | GPU tests | A full `test_operator_gpu.py` sweep is still incomplete on the current Linux/Ada host. GPU reruns are currently blocked by the host NVIDIA driver/userspace mismatch recorded in L9. |
