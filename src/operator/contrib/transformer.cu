...
void CublasStridedBatchedGemm(mshadow::Stream<gpu>* s,
                              bool transA,
                              bool transB,
                              int32_t m,
                              int32_t n,
  ...
  if (cc_major >= 5) {
    CUBLAS_CALL(cublasGemmStridedBatchedEx(blas_handle,
                                           CublasTransposeOp(transA),
                                           CublasTransposeOp(transB),
                                           static_cast<int>(m),
                                           static_cast<int>(n),
                                           static_cast<int>(k),
                                           alpha_ptr,
                                           a,
                                           CublasType<DType>::kCudaFlag,
                                           static_cast<int>(lda),
                                           strideA,
                                           b,
                                           CublasType<DType>::kCudaFlag,
    ...
    if (std::is_same<DType, float>::value) {
      ...
      CUBLAS_CALL(cublasDgemmStridedBatched(blas_handle,
                                            CublasTransposeOp(transA),
                                            CublasTransposeOp(transB),
                                            static_cast<int>(m),
                                            static_cast<int>(n),
      ...
      CUBLAS_CALL(cublasHgemmStridedBatched(blas_handle,
                                            CublasTransposeOp(transA),
                                            CublasTransposeOp(transB),
                                            static_cast<int>(m),
                                            static_cast<int>(n),
...
template <typename DType>
void gemm_switch_fp32accum(mshadow::Stream<gpu>* s,
                           bool transA,
                           bool transB,
                           int32_t m,
                           int32_t n,
