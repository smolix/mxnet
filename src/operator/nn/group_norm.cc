...
static bool GroupNormShape(const nnvm::NodeAttrs& attrs,
  ...
  SHAPE_ASSIGN_CHECK(*in_shape, groupnorm::kGamma, mxnet::TShape(Shape1(dshape[1])));
  SHAPE_ASSIGN_CHECK(*in_shape, groupnorm::kBeta, mxnet::TShape(Shape1(dshape[1])));
...
Both ``gamma`` and ``beta`` are learnable parameters.
    ...
    .set_attr<nnvm::FNumVisibleOutputs>("FNumVisibleOutputs",
                                        [](const NodeAttrs& attrs) {
                                          const GroupNormParam& param =
                                              nnvm::get<GroupNormParam>(attrs.parsed);
    ...
    .set_attr<nnvm::FGradient>("FGradient",
                               [](const nnvm::ObjectPtr& n,
                                 ...
                                 return MakeGradNode(
                                     "_backward_GroupNorm", n, heads, n->attrs.dict);
                               })
